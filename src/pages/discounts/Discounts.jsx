...
import { Loader2Icon, Trash2, Plus } from "lucide-react";
...
function Discounts() {
  ...
  const [updateDiscount, { isLoading: loadingUpdate }] = useUpdateDiscountMutation();
  ...
  const handleCreateDiscount = async () => {
    ...
    const existingCategories = discountStatus?.flatMap((d) => d.category) || [];
  ...
  const handleUpdateDiscount = async () => {
    await updateDiscount({ category: selectedCategories, discountBy: discount });
            ...
            <div className="flex mt-5 lg:mt-0 justify-between items-center ">
              ...
              <div className="flex ">
                <button
                  ...
                  className="bg-black   gap-1   transition-all text-white text-sm lg:text-md px-3 py-2 rounded-lg
                   font-semibold shadow-lg flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                ...
                <div className="flex flex-col w-full lg:w-1/2 ">
                  ...
                  <select
                    ...
                    value={discount}
                    className="w-full text-lg lg:text-lg cursor-pointer px-5 py-3 border border-gray-300 rounded-lg shadow-sm
             focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
                ...
                <div className="flex flex-col w-full lg:w-2/3">
                  ...
                  {categories?.length === 0 ? (
                    ...
                    <div
                      className="flex flex-wrap gap-3 max-h-40 overflow-y-auto px-2 py-2 border border-gray-300 rounded-lg
                     scrollbar-thin scrollbar-thumb-zinc-400 scrollbar-track-gray-100">
                      {categories?.map((cat) => (
                        <label
                          key={cat._id}
                          className="flex text-lg lg:text-lg items-center gap-2 border border-gray-300 px-4 py-1 cursor-pointer
                         hover:bg-zinc-50 transition select-none">
                          <input
                            type="checkbox"
                            value={cat.name}
              ...
              <div className="lg:mt-6 p-4 border rounded-lg bg-gray-50 ">
                ...
                <input
                  ...
                  className="w-full text-base px-4 py-3 border border-gray-300 rounded-md shadow-sm
                  focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                />
                {originalPrice && (
